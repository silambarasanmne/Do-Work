...
import { Rocket, ExternalLink, RefreshCw, Layers, CheckCircle2, ShieldCheck } from 'lucide-react';
...
export default function ReleaseSuccessCard({ 
  ...
  return (
    <div className="glass-strong rounded-xl p-4 sm:p-6 border border-white/90 shadow-lg relative overflow-hidden backdrop-blur-md mb-3 text-center max-w-4xl mx-auto">
      ...
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-tr from-[#96a01d] via-[#a8b422] to-[#7a8315] text-slate-950 flex items-center justify-center mx-auto mb-3 shadow-lg shadow-[#96a01d]/40 font-bold scale-105 animate-bounce">
        <Rocket className="w-7 h-7 sm:w-8 sm:h-8 stroke-[2.5]" />
      </div>

      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-[10px] sm:text-xs font-extrabold border border-emerald-200 mb-2">
      ...
      <div className="max-w-md mx-auto glass-card rounded-xl p-2.5 sm:p-3 border border-white/90 shadow-sm mb-4 text-left">
        ...
        <div className="flex items-center justify-between gap-2 font-mono text-xs text-slate-900 bg-white/80 p-2 rounded-lg border border-slate-200">
          <div className="flex items-center gap-1.5 truncate">
            ...
            <span className="truncate font-bold text-[11px] sm:text-xs">{liveUrl}</span>
          </div>

          <button
            onClick={() => onOpenApp(project)}
            className="px-2.5 py-1 rounded-md bg-[#96a01d] hover:bg-[#a8b422] text-slate-950 text-[10px] sm:text-xs font-extrabold flex items-center gap-1 shrink-0 transition-colors shadow-xs min-h-[32px]"
          >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 max-w-md mx-auto">
        <button
          onClick={() => onOpenApp(project)}
          className="w-full sm:w-auto px-5 py-3 rounded-xl bg-gradient-to-r from-[#96a01d] via-[#a8b422] to-[#7a8315] text-slate-950 font-extrabold text-xs shadow-md shadow-[#96a01d]/35 hover:scale-[1.01] active:scale-95 min-h-[44px] transition-all flex items-center justify-center gap-1.5"
        >
        ...
        <button
          ...
          className="w-full sm:w-auto px-5 py-3 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-extrabold text-xs border border-slate-200 shadow-xs active:scale-95 min-h-[44px] transition-all flex items-center justify-center gap-1.5"
        >
        ...
        <button
          ...
          className="w-full sm:w-auto px-5 py-3 rounded-xl bg-slate-950 hover:bg-slate-900 text-[#96a01d] font-extrabold text-xs shadow-md active:scale-95 min-h-[44px] transition-all flex items-center justify-center gap-1.5"
        >
